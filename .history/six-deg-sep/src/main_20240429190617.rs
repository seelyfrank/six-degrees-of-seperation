...
fn main() {
    ...
    // run_file("datasets/email-Eu-core.txt", 1005, 1000, true, false); // directed
    // run_file("datasets/epinions.txt", 75879, 100, true, false); // directed
    // run_file("datasets/slashdot0902.txt", 82168, 100, true, false); // undirected
    run_file("datasets/condense-matter-collab-net.txt", 23133, 100, true, false); // undirected
}
