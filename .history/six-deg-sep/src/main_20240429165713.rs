...
fn run_file(filename: &str, nodes: u32, test_iterations: u32, track_nodes: bool, print_adj_list: bool) {
    ...
    run_file_print(paths_found, connected, avg_len, longest_path, print_adj_list);

}

fn run_file_print(paths_found: u32, connected: f32, avg_len: f32, longest_path: u32, adj_list: bool) {
    println!("----------------------------------");
    println!("FILENAME: {}")
}
