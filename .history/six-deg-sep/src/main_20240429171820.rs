...
fn main() {
    run_file("directed.txt", 9, 500, false, false);
    run_file("directed_connected.txt", 9, 500, false, false);
}
...
mod tests {
    ...
    #[test]
    fn test_run_file_with_valid_file() {
        // Test running with a valid file
        let filename = "test_data/directed.txt"; // Assuming this file exists
        let nodes = 9;
    ...
    #[test]
    #[should_panic]
    fn test_run_file_with_invalid_file() {
        // Test running with an invalid file
    ...
    // Example of a test to check if the function prints adjacency list
    #[test]
    fn test_run_file_print_adjacency_list() {
        let filename = "test_data/directed.txt"; // Assuming this file exists
        let nodes = 9;
        let test_iterations = 500;
        let track_nodes = false;
