...
fn main() {
    run_file("datasets/directed.txt", 8, 500, false, true); // directed, set to show ajacency 
    run_file("datasets/directed_connected.txt", 8, 500, false, true); //directed
    run_file("datasets/email-Eu-core.txt", 1005, 1000, false, true); // directed
