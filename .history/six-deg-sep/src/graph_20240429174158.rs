...
mod tests {
    ...
    fn test_bfs_shortest_path() {
        ...
        assert_eq!(bfs_shortest(&graph.0, "2", "6"), Ok(2));
        assert_eq!(bfs_shortest(&graph.0, "2", "2"), Ok(1));
        assert_eq!(bfs_shortest(&graph.0, "0", "2"), Ok(1));
        assert_eq!(bfs_shortest(&graph.0, "1", "D"), Ok(2));
    }
